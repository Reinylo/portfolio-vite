            ...
            <div className="mx-auto mb-12 grid max-w-[1400px] grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-12">
                ...
                <div>
                    ...
                    <div className="footer-social flex flex-row gap-4">
                        ...
                        <a href="https://github.com/Sawsan-aa" className="flex h-10 w-10 items-center justify-center rounded-full border border-[var(--card-border)] bg-[var(--card-bg)] text-[var(--text)] no-underline transition-all duration-300 ease-in-out hover:-translate-y-1 hover:border-[var(--primary-purple)] hover:text-[var(--primary-purple)] hover:shadow-[0_8px_15px_rgba(124,58,237,0.3)]" aria-label="GitHub">
                            <FiGithub size={20} />
                        </a>
